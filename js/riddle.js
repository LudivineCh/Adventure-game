...
function webdevQuote() {
    ...
    switch (quoteReference) {
        ...
        case 1:
            ...
            break;
        case 2:
            webdevQuote = "Your website is the center of your digital eco-system,<br> like a brick and mortar location, <br> the experience matters once a customer enters, <br>just as much as the perception they have of you before they walk through the door. <br> ― Leland Dieno";
            break;
        case 3:
            webdevQuote = "Code is read more than it is written. <br> ― Daniel Roy Greenfeld & Audrey Roy Greenfeld";
            break;
        case 4:
            webdevQuote = "Web development is difficult, only then it is fun to do. You just have to set your standards. <br> If it were to be easy, would anyone do it? <br> ― Olawale Daniel";
            break;
        }
    return webdevQuote;
}