...
function readStory(nameInput, currentChapter) { 
  ...
  return {
    ...
    chapterTwo: {
      title: `Chapter 2: ${nameInput}is smart`,
    ...
    chapterThree: {
      title: `Chapter 3: ${nameInput}: the Chosen One`,
    ...
    chapterNine: {
      ...
      storyText: `Well done ${sessionStorage.getItem('hero')}, You throw the bambou spear right into the jaguar’s head. The jaguar falls in the floor and starts to burn. The ashes floats in the air into the shape of a human wearing a feathered skull, and a jaguar cape. The dark smoking shape whispers : 'I, Tezcatlipoca, will come back stronger' and then disappears into thin air. So, it was Quetzalcoatl’s brother behind all of this...<br><br> You walk closer to the golden tree, the weaked snake speacks : 'I, Quetzacoatl, need to feed on the magical fruits of the golden tree to survive. Unfortunately, I am too weak to see them. Please, guide me to them ?'. <br><br> The golden tree is growing on a purple lake, as you come closer you noticed that there is no fruit on the branches. You look down and see the fruits growing on the roots.<br><br>  Are you ready to throw Quetzacoatl into the mystical waters ?`, 
...
if (sessionStorage.getItem('memory') === 'passed') {
  ...
  button.addEventListener('click', function() {
    ...
    if (nameInput.value == "") {
      ...
      return;
        ...
        // store hero name
        sessionStorage.setItem('hero', nameInput.value);
        // Fill up our object "story" with content
